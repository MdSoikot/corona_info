...
<script src="{{asset("template_assets/assets/feather-icons/feather.min.js")}}"></script>

<script src="{{asset("template_assets/assets/vendors/perfect-scrollbar/perfect-scrollbar.min.js")}}"></script>
