                ...
                <div class="col-12 col-md-6 order-md-2 order-first">
                    <nav aria-label="breadcrumb" class='breadcrumb-header'>
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Show Information & Services</li>
                        </ol>
                    </nav>
                </div>
            </div>
                        ...
                        <tbody>
                            ...
                            @foreach ($allData as $item)
                                <tr>
                                    ...
                                    <td>
                                        <img src="{{asset($item->icon_image)}}" style="width: 50px;
                                        height: 60px;">
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <form class="form form-horizontal"
                                                    action="{{ route('info.update', $item->id) }}" method="POST"
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-12 form-group">
                                                                ...
                                                                <input type="file" id="first-name" class="form-control"
                                                                    ...
                                                                    <img src="<?php echo asset($item->icon_image); ?>" style="width: 50px;
                                                                    height: 60px;">
                                                                    @else
                                                                    No Image Uploaded
                                                                    @endif
